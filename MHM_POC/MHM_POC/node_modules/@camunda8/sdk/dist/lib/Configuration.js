...
const ZeebeGrpcAddressUtils_1 = require("./ZeebeGrpcAddressUtils");
...
CamundaEnvironmentConfigurator.mergeConfigWithEnvironment = (config) => {
    const mergedConfig = (0, lodash_mergewith_1.default)({}, exports.CamundaSDKConfiguration, config);
    ...
    if (mergedConfig.ZEEBE_GRPC_ADDRESS) {
        ...
        if (address.includes('://')) {
            try {
                (0, ZeebeGrpcAddressUtils_1.parseZeebeGrpcAddress)(address);
            }
            catch (error) {
    ...
    (0, ZeebeGrpcAddressUtils_1.emitDeprecationWarnings)(mergedConfig);
    // Emit warnings for conflicting settings
    (0, ZeebeGrpcAddressUtils_1.emitConflictWarnings)(mergedConfig);
    return mergedConfig;
};
/**
