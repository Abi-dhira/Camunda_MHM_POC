...
interface CreateProcessInstanceFromProcessDefinitionKey<V extends JSONDoc | LosslessDto> extends CreateProcessBaseRequest<V> {
    /**
     * the key of the process definition
     */
    processDefinitionKey: string;
}
export type CreateProcessInstanceRequest<T extends JSONDoc | LosslessDto> = CreateProcessInstanceFromProcessDefinitionId<T> | CreateProcessInstanceFromProcessDefinitionKey<T>;
...
export declare class UploadDocumentResponse extends LosslessDto {
...
export declare class EvaluatedOutput extends LosslessDto {
...
export declare class MatchedRule extends LosslessDto {
...
export declare class EvaluatedInput extends LosslessDto {
...
export declare class EvaluatedDecision extends LosslessDto {
...
export declare class EvaluateDecisionResponse extends LosslessDto {
    /** The ID of the decision which was evaluated. */
    decisionDefinitionId: string;
    /** The name of the decision which was evaluated. */
    decisionDefinitionName: string;
...
export declare class GetVariableResponse {
    variableKey: string;
    scopeKey: string;
    processInstanceKey: string;
    name: string;
